...
function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {[
        { top: "10%", left: "15%", size: 80, rotate: 25, dur: 6, delay: 0, img: 0 },
        { top: "14%", left: "30%", size: 55, rotate: -40, dur: 7, delay: 0.5, img: 2 },
        { top: "18%", right: "16%", size: 85, rotate: 60, dur: 5.5, delay: 1, img: 1 },
        ...
        { top: "22%", right: "12%", size: 60, rotate: 35, dur: 6, delay: 0.6, img: 5 },
        ...
        { top: "18%", left: "5%", size: 45, rotate: 10, dur: 5.8, delay: 1.1, img: 3 },
        ...
        { top: "16%", right: "32%", size: 40, rotate: 85, dur: 6, delay: 1.6, img: 3 },
      ...
      <div style={{ position: "relative", zIndex: 10, width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
        ...
        {/* "CAFÉ" — top-left area */}
        <div style={{ overflow: "hidden", position: "absolute", top: isMobile ? "25%" : "25%", right: isMobile ? "auto" : "calc(50% + min(19vw, 250px))", left: isMobile ? "6%" : "auto", zIndex: 12 }}>
          <motion.h1
            initial={{ y: "110%" }}
            animate={{ y: 0 }}
        ...
        <div style={{ overflow: "hidden", position: "absolute", top: isMobile ? "auto" : "45%", bottom: isMobile ? "25%" : "auto", left: isMobile ? "auto" : "calc(50% + min(24.5vw, 320px))", right: isMobile ? "6%" : "auto", zIndex: 12 }}>
          <motion.h1
            initial={{ y: "110%" }}
            animate={{ y: 0 }}
